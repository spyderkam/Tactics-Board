...
line_points = []  # Add this line to define line_points globally
...
if __name__ == '__main__':
  ...
  pygame.init()
  socketio.run(app, host='0.0.0.0', port=80, allow_unsafe_werkzeug=True, use_reloader=False, log_output=True)