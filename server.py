...
def update_board():
  ...
  pygame.draw.arc(SCREEN, WHITE, (240, HEIGHT//2-120, 160, 240), 0.96, 2.18, 2)  # Left penalty arc
  pygame.draw.arc(SCREEN, WHITE, (WIDTH-400, HEIGHT//2-120, 160, 240), 0.96, 2.18, 2) # Right penalty arc
